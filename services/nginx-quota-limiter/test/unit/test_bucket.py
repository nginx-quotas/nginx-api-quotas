"""Unit Test for Each Function of Quota Limiter Bucket"""
...
def test_clear_and_quota_limit_remaining():
    ...
    bucket = QuotaLimitBucket(DEFAULT_RPS, DEFAULT_TIME_WINDOW)
    bucket.clear()
...
def test_decrement_cur_remaining():
    ...
    clock = FakeClock(10)
    bucket = QuotaLimitBucket(DEFAULT_RPS, DEFAULT_TIME_WINDOW, clock)
