# -----------------------------------------------------------------------------#
#                                                                              #
#           Running Script for Testing Quota Limiter with Report               #
#                                                                              #
# -----------------------------------------------------------------------------#
...
#
# Run functional test cases for the quota limiter.
#
printf "\n"
printf "${YELLOW}+--------------------------------------------------------+\n"
printf "${YELLOW}|                                                        |\n"
...
printf "${YELLOW}|                                                        |\n"
printf "${YELLOW}|     (Quota Limiter Client -> Quota Limiter & Bucket)   |\n"
printf "${YELLOW}|                                                        |\n"
printf "${YELLOW}+--------------------------------------------------------+\n"
